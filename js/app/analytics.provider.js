(function(ADB, DataLayer, SamplePlayerDelegate) {
    'use strict';
    ...
    AnalyticsProvider.prototype.attachToPlayer = function(player) {
        ...
        var configData = new ConfigData(digitalData.HEARTBEAT.TRACKING_SERVER,
            digitalData.HEARTBEAT.JOB_ID,
            digitalData.HEARTBEAT.PUBLISHER);

        configData.ovp = digitalData.HEARTBEAT.OVP;
        configData.sdk = digitalData.HEARTBEAT.SDK;
        configData.channel = digitalData.HEARTBEAT.CHANNEL;
...
})(window.ADB, window.DataLayer, window.SamplePlayerDelegate);
